<div id="4" class="svg_plts">
	...
	For this overview and the single stations the figures may be shown for a specific station of for specific variable (e.g. temperature and humidity). For each station a map showing the wind field and location is included again under information. Such wind fields and corresponding maps are separated into wind during night and day as indicated by the colors. Further, the newest wind vector at the time of creation is indicated with an orange arrow. If no wind is measured, just the location may be indicated</p>

        <h3>Dolueg2</h3>
        <p>Contrary to the previous version, figures are created as SVGs (scalable vector graphics). As the name indicates, these are vectors graphs instead of typical raster images and are thus scalable. To keep the layout somewhat consistent, for the zoom/scale functionality you will have to drag the figures to a new/other browser tab.
